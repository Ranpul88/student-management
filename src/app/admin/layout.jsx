    ...
    return(
        <div className="w-full h-full flex bg-accent items-center justify-center">
            <div className="w-75 h-full bg-accent flex justify-center p-3">
                <div className="w-full h-full bg-white rounded-4xl pt-2">
                    <div className="w-full h-30 flex items-center">
                        <img src="/logo.png" alt="" className="h-20 pl-2"/>
                        <h2 className="text-xl font-medium text-accent">Admin</h2>
                    </div>
                    <div className="w-full h-[calc(100%-120px)] flex flex-col items-center text-2xl pt-8 gap-2">
