...
export default function AdminStudentPage() { 
  ...
  useEffect(() => {
    const res = fetch(process.env.NEXT_PUBLIC_BACKEND_URL + '/admin/students', {
      method: 'GET',
      headers: {
  ...
  return (
    <div className="h-full bg-linear-to-br from-primary via-white to-blue-50 p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header Section */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-secondary mb-2">Students Directory</h1>
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              <p className="text-sm font-medium text-secondary">{student.userID}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
